    ...
    return (
        <div className="EducationText">
            ...
            <p>My threads (focuses) are&nbsp;
                <a className="App-link" href="https://www.cc.gatech.edu/academics/threads/intelligence">Intelligence</a> and&nbsp;
                <a className="App-link" href="https://www.cc.gatech.edu/academics/threads/information-internetworks">Information Internetworks</a>
            </p>
